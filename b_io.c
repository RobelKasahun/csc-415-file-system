...
int b_seek(b_io_fd fd, off_t offset, int whence)
{
	...
	b_fcb *temp_fcb = &fcbArray[fd];

	return (set_index(whence, offset, temp_fcb)); // Change this
}

int set_index(int whence, off_t offset, b_fcb *fcb)
{
	if (whence == SEEK_END)
	{
		fcb->index = fcb->buflen + offset;
	}
